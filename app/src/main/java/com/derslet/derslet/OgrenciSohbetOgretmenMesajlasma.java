...
public class OgrenciSohbetOgretmenMesajlasma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ogrenci_sohbet_ogretmen_mesajlasma);
        ...
        geri_buton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                OgrenciSohbetOgretmenMesajlasma.this.overridePendingTransition(R.anim.fadein,R.anim.fadeout);
            }
        });

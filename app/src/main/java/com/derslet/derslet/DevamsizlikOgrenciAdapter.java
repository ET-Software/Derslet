...
public class DevamsizlikOgrenciAdapter extends ArrayAdapter<Devamsizlik> {
    private Context mContext;
    private int mResource;

    public DevamsizlikOgrenciAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Devamsizlik> objects) {
